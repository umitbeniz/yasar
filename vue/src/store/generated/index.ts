...
import UmitbenizYasarUmitbenizYasarYasar from './umitbeniz/yasar/umitbeniz.yasar.yasar'
...
export default { 
  ...
  UmitbenizYasarUmitbenizYasarYasar: load(UmitbenizYasarUmitbenizYasarYasar, 'umitbeniz.yasar.yasar'),
